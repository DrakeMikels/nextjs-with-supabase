      ...
      <div className="flex min-h-screen w-full items-center justify-center p-6 md:p-10 relative z-10">
        <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="grid gap-4">
              {[
                ...
                <motion.div
                  key={feature.title}
                  className="flex items-center gap-4 p-4 bg-white/20 backdrop-blur-sm rounded-lg border border-white/30 hover-lift"
          ...
          >
            ...
            <motion.div 
              className="bg-white/98 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-white/50"
