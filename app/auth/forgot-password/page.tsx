...
export default function Page() {
  return (
    ...
    >
      ...
      {/* Floating Elements */}
      <motion.div 
        className="absolute top-32 left-20 w-24 h-24 bg-brand-olive/10 rounded-full blur-xl"
      ...
      />
      <motion.div 
        className="absolute bottom-20 right-32 w-32 h-32 bg-brand-olive-light/10 rounded-full blur-xl"
        initial={{ opacity: 0, scale: 0 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{
          duration: 0.8,
        ...
        >
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-2xl font-bold text-brand-olive">Reset Password</h1>
            </div>
